...
def test_eval(
            ...
            type:str = "cla",
            save_md_path:str = Path(__file__) / "../output/cla_svm_out.md" ,
            save_json_path: str = Path(__file__) / "../output/cla_svm_outj.json" ,
...
if __name__ == "__main__":
    ...
    test_eval(model_save_path = Path(__file__) / "../save_model/20_0_0_3_train_up_model.pickle",
              test_path = Path(__file__).parent.parent.parent / "../../data/up/20_0_0_3_test_up_model.txt",
              type = "cla", 
              save_md_path = Path(__file__) / "../output/cla_svm_out.md" , 
              save_json_path = Path(__file__) / "../output/cla_svm_outj.json" , 
